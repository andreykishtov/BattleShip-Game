class CommunicationLogic {
  ...
  endGame(usernameOfWinner, NameOfloser, toall) {
    toall
      ? sendEndGameNotifications(usernameOfWinner, NameOfloser)
      : initEndGame(usernameOfWinner, NameOfloser);
  }
